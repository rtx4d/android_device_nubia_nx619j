...
blob_fixups: blob_fixups_user_type = {
    ...
    ('vendor/lib64/vendor.goodix.hardware.biometrics.fingerprint@2.1.so',  'vendor/lib64/vendor.nubia.ifaa@1.0.so', 'vendor/lib64/vendor.qti.hardware.fingerprint@1.0.so') : blob_fixup()
        .replace_needed('libhidlbase.so', 'libhidlbase-v32.so'),
    ('vendor/lib/libarcsoft_beautyshot_video_algorithm.so', 'vendor/lib/libswregistrationalgo.so') : blob_fixup()
